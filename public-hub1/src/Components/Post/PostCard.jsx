...
// import { CommentModal } from 'react-react'
const PostCard = () => {
            ...
            <div className='border rounded-md w-full'>
                <div className='flex justify-between items-center w-full py-4 px-5'>
                    <div className='flex items-center'>
                        <img className='h-12 w-12 rounded-full' src='https://cdn.pixabay.com/photo/2023/03/05/19/51/ai-generated-7832126_640.jpg'
                            alt=''
                        />
                        <div className='pl-2'>
                ...
                <div className='w-full'>
                    <img className="w-full" src='https://cdn.pixabay.com/photo/2023/07/30/15/28/ai-generated-8159126_640.png' alt='' />
                </div>
                <div className='flex justify-between items-center w-full py-4 px-5'>
