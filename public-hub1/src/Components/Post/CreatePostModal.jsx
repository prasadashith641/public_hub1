    ...
    <div>
      <Modal size={"4xl"} onClose={onClose} isOpen={isOpen} isCentered>
        ...
        <ModalContent>
          ...
          <hr />
          <ModalBody>
            <div className="h-[80vh] justify-between pb-5 flex">
              <div className="w-[50%]">

                {!file && <div
                  onDrop={handleDrop}
                  onDragOver={handleDragOver}
                  onDrabgLeave={handleDragLeave}
              ...
              <div className="w-[50%]">
                <div className="flex item-center px-2">
                  <img className="w-7 h-7 rounded-full" src="https://cdn.pixabay.com/photo/2023/03/05/19/51/ai-generated-7832125_640.jpg" alt="" />
